...
\begin{abstract}
Raspberry Pi, GPIO, REBT, ICT, Autónomo, Sistema Domótico, Linux, Bot, Telegram, Bash scripting.
...
Raspberry Pi, GPIO, REBT, ICT, Standalone, Domotic System, Linux, Bot, Telegram, Bash scripting.
\end{abstract}
